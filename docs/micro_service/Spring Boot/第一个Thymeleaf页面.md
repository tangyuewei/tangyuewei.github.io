...
meta:
  ...
  - name: keywords
    content: 唐悦玮,第一个 Thymeleaf 页面,Thymeleaf 依赖,配置 Thymeleaf,Thymeleaf使用
---
# 第一个 Thymeleaf 页面
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <groupId>com.tangyuewei</groupId>
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.tangyuewei.hello.spring.boot.HelloSpringBootApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
